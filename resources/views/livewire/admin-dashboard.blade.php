...
<section class="container mx-auto p-6 font-mono">
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
      ...
      @foreach ($activity as $activitys)
              ...
              <td class="px-4 py-3 border text-md font-semibold">{{ $activitys->user->name }} </td>
              ...
              <td> <button wire:click="delete('{{ $activitys->id }}')" class="bg-red-500 hover:bg-red-500 text-white font-bold py-2 px-4 rounded">Delete</button> </td>
            </tr>
            @endforeach
          </tbody>
        </table>
